...
open class VersaPlayerControls: View {
    ...
    @IBAction open func skipForward(sender _: Any? = nil) {
    ...
    @IBAction open func skipBackward(sender _: Any? = nil) {
        let time = handler.player.currentTime() - CMTime(seconds: skipSize, preferredTimescale: CMTimeScale(NSEC_PER_SEC))
        handler.player.seek(to: time)
    }

    /// End seeking
    @IBAction open func seekingEnd(sender _: Any? = nil) {
    ...
    /// Start Seeking
    @IBAction open func seekingStart(sender _: Any? = nil) {
    ...
    @IBAction open func toggleFullscreen(sender _: Any? = nil) {
    ...
    /// Toggle rewind
    @IBAction open func rewindToggle(sender _: Any? = nil) {
    ...
    /// Forward toggle
    @IBAction open func forwardToggle(sender _: Any? = nil) {

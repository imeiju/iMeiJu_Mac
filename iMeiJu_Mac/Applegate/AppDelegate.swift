...
@NSApplicationMain
    ...
    @IBAction func update(_ sender: Any) {
        ...
        let _ = query.get("5c5c39d844d90424cf9acaa9") { (result) in
            switch result {
            case .success(object: let object):
                if (object.get("version")?.floatValue)! > Float(1.2) {
                    if object.get("forceUpdate")!.intValue! == 1 {
                        ...
                        alert.beginSheetModal(for:NSApplication.shared.keyWindow!) { (finished)in
